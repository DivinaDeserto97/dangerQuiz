...
(308, 'What is the title of the first Avengers film, released in 2012?', 'movies.jpg', 'SINGLE', 'movies'),
(309, 'What is the name of the ring at the center of the story in \"The Lord of the Rings\"?', 'movies.jpg', 'SINGLE', 'movies'),
(310, 'Who directed the film \"Interstellar\"?', 'movies.jpg', 'SINGLE', 'movies'),
(401, 'Do you play Dnd?', 'd-n-d.jpg', 'SINGLE', 'd-n-d'),
...
(801, 'On which continent lies São Paulo?', 'geography.jpg', 'SINGLE', 'geography'),
(802, 'Where would you find the Ore Mountains?', 'geography.jpg', 'SINGLE', 'geography'),
(803, 'The Pyrenees-Mediterranean region is located along the border of which two countries?', 'geography.jpg', 'SINGLE', 'geography'),
(804, 'Where would you find the Tornio River?', 'geography.jpg', 'SINGLE', 'geography'),
(805, 'Alaska used to be part of Russia.', 'geography.jpg', 'SINGLE', 'geography'),
(806, 'Victoria is the capital of the Republic of Seychelles.', 'geography.jpg', 'SINGLE', 'geography'),
(807, 'What port on the Atlantic Ocean is the capital and largest city of Guinea?', 'geography.jpg', 'SINGLE', 'geography'),
(809, 'What is the name of the capital city of Latvia?', 'geography.jpg', 'SINGLE', 'geography'),
(810, 'Tegucigalpa is the capital and largest city of this country:', 'geography.jpg', 'SINGLE', 'geography'),
(811, 'Where were the Boer Republics located?', 'geography.jpg', 'SINGLE', 'geography'),
(812, 'Where was the monastic state of the Teutonic Knights located?', 'geography.jpg', 'SINGLE', 'geography'),
(813, 'Which independent country was not a Soviet republic?', 'geography.jpg', 'SINGLE', 'geography'),
(814, 'Myanmar is a south-eastern Asian country. Under which name was it known before a military junta took over?', 'geography.jpg', 'SINGLE', 'geography'),
(815, 'By the end of the 16th century, a country called Commonwealth of Both Nations covered almost 1 million square kilometers of Europe. Which two countries formed it?', 'geography.jpg', 'SINGLE', 'geography'),
(816, 'The African kingdom of Dahomey was powerful in the XVIII century. Which modern day country did it cover?', 'geography.jpg', 'SINGLE', 'geography'),
(817, 'Which of the following oceans is the worlds largest?', 'geography.jpg', 'SINGLE', 'geography'),
(818, 'On which of the Canary Islands is the Mount Teide volcano located?', 'geography.jpg', 'SINGLE', 'geography'),
(819, 'On which of the Philippine islands is the active Taal Volcano located?', 'geography.jpg', 'SINGLE', 'geography'),
(820, 'What is the name of the dangerous active volcano located in the Western Highlands of Guatemala?', 'geography.jpg', 'SINGLE', 'geography'),
(821, 'This Russian volcano, located on the Kamchatka Peninsula, is one of the most active volcanoes on the planet:', 'geography.jpg', 'SINGLE', 'geography'),
(822, 'The Santorini volcanic islands are part of what European country?', 'geography.jpg', 'SINGLE', 'geography'),
(823, 'What is the name of the largest volcano on Earth in terms of area?', 'geography.jpg', 'SINGLE', 'geography'),
(824, 'Luxembourg is bordered by all of the following nations except this one.', 'geography.jpg', 'SINGLE', 'geography'),
(825, ' What sea borders Egypt to the east?', 'geography.jpg', 'SINGLE', 'geography'),
(826, 'The islands of the Pacific are collectively termed Oceania. Oceania is divided into several sub-groupings. In which of these is New Guinea located?', 'geography.jpg', 'SINGLE', 'geography'),
(827, 'What is the capital city of the country of Papua New Guinea?', 'geography.jpg', 'SINGLE', 'geography'),
(828, 'The island of New Guinea was named after the country of Guinea. Which is Guinea located?', 'geography.jpg', 'SINGLE', 'geography'),
(829, 'Madagascar is the worlds largest producer and exporter of what product?', 'geography.jpg', 'SINGLE', 'geography'),
(830, 'In what country is the Angel Falls, the highest waterfall on the planet, located?', 'geography.jpg', 'SINGLE', 'geography'),
(831, 'The national motto of this South American country is Libertad o muerte, Spanish for Liberty or Death:', 'geography.jpg', 'SINGLE', 'geography'),
(832, 'Which of the following places in Greece is NOT an island?', 'geography.jpg', 'SINGLE', 'geography'),
...
(1007, 'What is the only natural satellite of the Earth? ', 'science.jpg', 'SINGLE', 'science'),
...
(1011, 'What is the death of each member of a species called? ', 'science.jpg', 'SINGLE', 'science'),
(1012, 'What is the closest planet to the Sun?', 'science.jpg', 'SINGLE', 'science'),
...
(1101, 'Quelle balise utilisera-t-on de préférence pour le titre principal d\'une page html:', 'informatics.jpg', 'SINGLE', 'informatics'),
(1102, 'Utiliser la balise h1 signifie que l\'on veut que le titre apparaisse plus gros que si l\'on utilisait la balise h2 :', 'informatics.jpg', 'SINGLE', 'informatics'),
(1103, 'Pour mettre en gras une partie de texte dans une page html:', 'informatics.jpg', 'SINGLE', 'informatics'),
(1104, 'Les commentaires en HTML commencent par <code>&lt;!--</code> et finissent par <code>--&gt;</code>.', 'informatics.jpg', 'SINGLE', 'informatics'),
(1105, 'En HTML5, la balise <code>&lt;header&gt;</code> a le même rôle que la balise <code>&lt;head&gt;</code> ?', 'informatics.jpg', 'SINGLE', 'informatics'),
(1106, 'On souhaite rédiger une page html avec des énoncés et des corrections.<br>\r\nPour cela, on va utiliser la balise < div>. Quel est l\'attribut de < div> qui permettra de différencier les énoncés des corrections?', 'informatics.jpg', 'SINGLE', 'informatics'),
(1107, ' Quel est le doctype d\'un document HTML5 ?', 'informatics.jpg', 'SINGLE', 'informatics'),
(1108, ' Pour créer un lien vers la page d\'accueil de Wikipédia, on écrira:', 'informatics.jpg', 'SINGLE', 'informatics'),
(1109, 'Quels éléments sont nécessaires pour créer une liste dont les items ne sont pas numérotés ?', 'informatics.jpg', 'SINGLE', 'informatics'),
(1110, 'Laquelle de ces syntaxes est correcte pour embarquer une image dans la page html?', 'informatics.jpg', 'SINGLE', 'informatics'),
(1111, 'Le rôle du CSS est de:', 'informatics.jpg', 'SINGLE', 'informatics'),
(1112, ' Laquelle de ces pratiques doit être exceptionnelle (c\'est à dire très rarement utilisée):', 'informatics.jpg', 'SINGLE', 'informatics'),
...
(1212, 'Which painting of Leonardo da Vinci is the most famous one?', 'gen-knowledge.jpg', 'SINGLE', 'gen-knowledge'),
